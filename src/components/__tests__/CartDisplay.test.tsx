...
import CartDisplay, { type CartDisplayProps } from '../CartDisplay'
import userEvent from '@testing-library/user-event'

type CartContents = CartDisplayProps['cartContents']
...
describe('MobileCartDisplay', () => {
  ...
  it('should render cart header and content when cartContents is provided', () => {
    ...
    // Act
    render(
      <CartDisplay cartContents={cartContents} clearCart={clearCartMock} />
    )
